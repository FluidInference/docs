...
|-----------|-------|-------|----------|-----------|
| **Transcription** | Parakeet TDT 0.6B | 210x RTFx | 2.5% WER (en), 14.7% avg | 25 European |
...
All benchmarks on M4 Pro. See [full benchmarks](/reference/benchmarks) for per-language breakdowns and device comparisons.
...
Want to convert your own models to CoreML? See [mobius](https://github.com/FluidInference/mobius).
