...
| Model | Languages | Speed | Accuracy | Use Case |
|-------|-----------|-------|----------|----------|
| **Parakeet TDT v3** | 25 European | 210x RTFx | 14.7% avg WER | Default — multilingual |
| **Parakeet TDT v2** | English only | 146x RTFx | 2.1% WER | Best English accuracy |
| **Parakeet EOU** | English | 12x RTFx | 4.9% WER | Real-time streaming |
